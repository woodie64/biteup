...
Revision ID: 64fbaf111bed
Revises: 58761e699c9b
Create Date: 2022-03-27 14:37:25.937335
...
revision = '64fbaf111bed'
down_revision = '58761e699c9b'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['question_id'], ['community.id'], name=op.f('fk_question_voter_question_id_question'), ondelete='CASCADE'),
